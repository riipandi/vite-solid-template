...
export const Toast = <T extends ValidComponent = 'li'>(
  ...
  return (
    <ToastPrimitive class={clx(toastVariants({ variant: local.variant }), local.class)} {...rest} />
  )
}
...
export const ToastTitle = <T extends ValidComponent = 'div'>(
  ...
  return (
    <ToastPrimitive.Title
      class={clx('font-semibold text-sm [&+div]:text-xs', local.class)}
      {...rest}
    />
  )
}
...
export const ToastDescription = <T extends ValidComponent = 'div'>(
  ...
  return <ToastPrimitive.Description class={clx('text-sm opacity-90', local.class)} {...rest} />
}
...
export const ToastContent = (props: ComponentProps<'div'>) => {
  ...
  return (
    <div class={clx('flex w-full flex-col', local.class)} {...rest}>
