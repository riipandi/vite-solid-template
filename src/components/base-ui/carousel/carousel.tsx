  ...
  return (
    <CarouselContext.Provider value={value}>
      <div
        ...
        class={clx('relative', local.class)}
        // biome-ignore lint/a11y/useSemanticElements: the only element that can be used as a container for the carousel.
        role="region"
...
export const CarouselContent = (props: ComponentProps<'div'>) => {
  ...
  return (
    <div ref={carouselRef} class="overflow-hidden">
      <div
        class={clx('flex', orientation === 'horizontal' ? '-ml-4' : '-mt-4 flex-col', local.class)}
        {...rest}
      />
    </div>
  )
