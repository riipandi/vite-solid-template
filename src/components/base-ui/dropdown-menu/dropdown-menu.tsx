...
export const DropdownMenuGroupLabel = <T extends ValidComponent = 'span'>(
  ...
  return (
    <DropdownMenuPrimitive.GroupLabel
      as="div"
      class={clx('px-2 py-1.5 font-semibold text-sm', local.class)}
      {...rest}
    />
  )
}
...
export const DropdownMenuSeparator = <T extends ValidComponent = 'hr'>(
  ...
  return (
    <DropdownMenuPrimitive.Separator
      class={clx('-mx-1 my-1 h-px bg-muted', local.class)}
      {...rest}
    />
  )
}
...
export const DropdownMenuShortcut = (props: ComponentProps<'span'>) => {
  ...
  return <span class={clx('ml-auto text-xs tracking-widest opacity-60', local.class)} {...rest} />
}
