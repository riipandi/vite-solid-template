...
export const ImageRoot = <T extends ValidComponent = 'span'>(
  ...
  return (
    <ImagePrimitive
      class={clx('relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full', local.class)}
      {...rest}
    />
  )
}
...
export const Image = <T extends ValidComponent = 'img'>(
  ...
  return <ImagePrimitive.Img class={clx('aspect-square h-full w-full', local.class)} {...rest} />
}
