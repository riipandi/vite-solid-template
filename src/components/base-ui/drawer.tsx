...
export const DrawerHeader = (props: ComponentProps<'div'>) => {
  ...
  return <div class={clx('grid gap-1.5 p-4 text-center sm:text-left', local.class)} {...rest} />
}

export const DrawerFooter = (props: ComponentProps<'div'>) => {
  const [local, rest] = splitProps(props, ['class'])

  return <div class={clx('mt-auto flex flex-col gap-2 p-4', local.class)} {...rest} />
}
...
export const DrawerLabel = <T extends ValidComponent = 'h2'>(
  ...
  return (
    <DrawerPrimitive.Label
      class={clx('font-semibold text-lg leading-none tracking-tight', local.class)}
      {...rest}
    />
  )
}
