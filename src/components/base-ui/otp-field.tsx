...
export const OTPField = <T extends ValidComponent = 'div'>(
  ...
  return (
    <OTPFieldPrimitive
      class={clx('flex items-center gap-2 has-[:disabled]:opacity-50', local.class)}
      {...rest}
    />
  )
}
...
export const OTPFieldGroup = (props: ComponentProps<'div'>) => {
  ...
  return <div class={clx('flex items-center', local.class)} {...rest} />
}

export const OTPFieldSeparator = (props: ComponentProps<'div'>) => {
  return (
    // biome-ignore lint/a11y/useFocusableInteractive: This is a decorative element
    // biome-ignore lint/a11y/useSemanticElements: This is a decorative element
...
export const OTPFieldSlot = (props: ComponentProps<'div'> & { index: number }) => {
  ...
  return (
    <div
      class={clx(
        'relative flex size-9 items-center justify-center border-input border-y border-r text-sm shadow-sm transition-shadow first:rounded-l-md first:border-l last:rounded-r-md',
